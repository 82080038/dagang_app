            ...
            <div>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?= $this->url('/export?format=json') ?>">
                            <i class="bi bi-filetype-json me-2"></i>JSON
                        </a></li>
                        <li><a class="dropdown-item" href="<?= $this->url('/export?format=csv') ?>">
...
<div class="row mb-4">
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-primary text-white dashboard-card primary">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4 class="card-title"><?= $companyStats['total_companies'] ?></h4>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-success text-white dashboard-card success">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4 class="card-title"><?= $companyStats['active_companies'] ?></h4>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-info text-white dashboard-card info">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4 class="card-title"><?= $branchStats['total_branches'] ?></h4>
                        <p class="card-text">Total Cabang</p>
                    </div>
                    <div class="align-self-center">
                        <i class="bi bi-shop display-4 opacity-75"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-warning text-white dashboard-card warning">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4 class="card-title"><?= count($openBranches) ?></h4>
                        <p class="card-text">Cabang Buka</p>
                    </div>
                    <div class="align-self-center">
                        <i class="bi bi-door-open display-4 opacity-75"></i>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row mb-4">
    <div class="col-lg-6 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <canvas id="scalabilityChart" height="200"></canvas>
            </div>
        </div>
    </div>
...
function loadScalabilityChart() {
    fetch('<?= $this->url('/dashboard/scalability') ?>')
...
function loadSegmentChart() {
    fetch('<?= $this->url('/dashboard/segments') ?>')
        .then(response => response.json())
        .then(data => {
