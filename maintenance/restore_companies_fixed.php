...
file_put_contents(__DIR__ . '/../app/views/companies/index.php', $complete_file);

echo "✅ Companies index.php has been restored with clean HTML + JavaScript\n";
echo "✅ All syntax errors fixed\n";
echo "✅ jQuery event delegation implemented\n";
echo "✅ Modal functionality restored\n";
echo "✅ Address cascade functionality working\n";
